...
class CourseSummaryPageControllerTest extends FunctionalTestCase
{
    ...
    /**
     * Creates the course instance under test before each test case.
     */
    protected function setUp()
    {
        ...
        $testCourseOne = $creator->createCourse('CS101', 'Programming', null);
        $courseInstance = $creator->createCourseInstance($testCourseOne, $courseStart, $courseEnd);
    ...
    {
        $creator = $this->getEntityCreator();
        $testNonMemberStudent = $creator->createStudent('testFirstname', 'testSurname', '2345678');
        $client = static::createClient();
