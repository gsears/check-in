...
/*
LabSummaryPageControllerTest.php
 ...
 */
class LabSummaryPageControllerTest extends FunctionalTestCase
{
    ...
    public function testAnonymousUserRedirected()
    {
        ...
        $client->request('GET', '/courses/CS101/1/lab/lab-one');
